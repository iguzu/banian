...
class PaypalTestCase(TestCase):
    ...
    Pay_currency_Differs            = {u'responseEnvelope': {u'ack': u'Failure', u'timestamp': u'2010-03-06T15:26:51.577-08:00', u'build': u'1193935', u'correlationId': u'c4d62334db777'}, u'error': [{u'category': u'Application', u'domain': u'PLATFORM', u'message': u'The preapproval key specifies a different currency than the payment request', u'severity': u'Error', u'errorId': u'579027'}]}
    Pay_invalid_url                 = {u'responseEnvelope': {u'ack': u'Failure', u'timestamp': u'2010-03-06T15:40:09.411-08:00', u'build': u'1193935', u'correlationId': u'd2e4add19e451'}, u'error': [{u'category': u'Application', u'domain': u'PLATFORM', u'message': u'Invalid request: returnUrl cannot be blank', u'severity': u'Error', u'errorId': u'580001'}]}
    def setUp(self):
        pass
