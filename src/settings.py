...
COMBINE_MEDIA = {
    'combined-%(LANGUAGE_CODE)s.js': (
        ...
        '.site_data.js',
        'global/jquery-ui/jquery.timepickr.js'
    ),
    'combined-%(LANGUAGE_DIR)s.css': (
        'global/look.css',
        'global/jquery-ui/jquery.timepickr.css',
        'global/jquery-ui/jquery-ui.css',
        'global/sexybuttons/sexybuttons.css',
...
AUTH_ADMIN_MODULE = 'registration.admin'
# Hybrid Django/Google authentication
